...
//    }
    ...
    fun testEmptyStringInput() {
        ...
        assertEquals("Текст не должен измениться при пустом вводе", originalText, newText)
    }

    @Test
    fun testNewActivityLaunch() {
        val packageName = MODEL_PACKAGE
        waitForPackage(packageName)

        val testText = "Hello UI Automator"
        ...
        assertEquals("Текст во второй Activity должен совпадать", testText, resultText)
    }
